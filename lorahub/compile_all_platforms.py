...
""",
    "lilygo_t3s3_lora32_sx1262": """
# Build options for Lilygo T3S3 LoRa32 SX1262
CONFIG_LILYGO_T3S3_LORA32=y
CONFIG_RADIO_TYPE_SX1262=y
CONFIG_GATEWAY_DISPLAY=y
""",
...
CONFIG_GATEWAY_DISPLAY=y
""",
    "seeed_xiao_esp32s3_devkit": """
# Build options for Seeed XIAO ESP32S3 Devkit
CONFIG_SEEED_XIAO_ESP32S3_DEVKIT=y
CONFIG_RADIO_TYPE_SX1262=y
CONFIG_GATEWAY_DISPLAY=n
""",
    "ebytes_esp32_lr1121": """
# Build options for EBytes ESP32+LR1121
CONFIG_EBYTES_ESP32_LR1121=y
CONFIG_RADIO_TYPE_LR1121=y
CONFIG_GATEWAY_DISPLAY=y
"""
}
